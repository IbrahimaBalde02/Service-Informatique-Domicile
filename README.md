...
- Migration de **Python 3.14 → 3.12.6** pour plus de stabilité et compatibilité avec Django.
- Ajout des **services disponibles** sur la page **"Nos Services"**.
- Optimisation du code et nettoyage de l’environnement de développement.
...
État du projet
En développement — les principales pages sont fonctionnelles (Accueil, Liste des services, A propos, Contact, Connexion).
Les prochaines étapes incluent l’ajout du Tableau de bord avancé et système de reservation en ligne
